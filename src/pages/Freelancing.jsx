...
const PLATFORMS = [
  ...
  },
  {
    ...
    logoText: 'BKR',
    logoBg: '#fafafa',
    logoImg: '/logos/Frame 1171275996.png',
    description: 'Designed and developed the frontend website interface for Bike Ride.',
    tags: ['Website Design', 'Frontend Development', 'UI/UX'],
  },
  {
    id: 'pathshala',
    platform: 'Pathshala Education',
    badge: 'UI/UX Redesign',
    role: 'Website Redesigner',
    period: '2026',
    logoText: 'PSE',
    logoBg: '#fafafa',
    logoImg: '/logos/688b4830a133e.jpg',
    description: 'Conducted a comprehensive UI/UX redesign of the Pathshala Education website to enhance user engagement.',
...
const FREELANCE_WORKS = [
  ...
  { id: '24', title: 'Bike Ride Frontend Website Design', client: 'Bike Ride', period: '2026', category: 'Development & Design', status: 'Completed' },
  { id: '25', title: 'Pathshala Education UI/UX Redesign', client: 'Pathshala Education', period: '2026', category: 'UI/UX Design', status: 'Completed' },
...
const BRANDS = [
  ...
  { name: 'Bike Ride', icon: '/logos/Frame 1171275996.png' },
  ...
  { name: 'Pathshala Education', icon: '/logos/688b4830a133e.jpg' },
