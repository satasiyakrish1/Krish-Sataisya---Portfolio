...
const TECH_CATEGORIES = [
  ...
  },
  {
    id: 'creative', label: 'Creative Tools', skills: [
      ...
      { name: 'Spline', icon: 'https://cdn.simpleicons.org/spline/000000' },
      ...
      { name: 'ProtoPie', icon: 'https://www.vectorlogo.zone/logos/protopie/protopie-icon.svg' },
      { name: 'Notion', icon: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Notion_app_logo.png' },
      { name: 'Webflow', icon: 'https://cdn.simpleicons.org/webflow/4353FF' },
      { name: 'Zeplin', icon: 'https://cdn.simpleicons.org/zeplin/F7893B' },
  ...
  },
  {
    id: 'ai', label: 'AI Tools', skills: [
      ...
      { name: 'Stable Diffusion', icon: 'https://cdn.simpleicons.org/stablediffusion/000000' },
