...
const ALL_PROJECTS = [
  ...
  },
  {
    ...
    category: 'Full Stack Web Applications',
    tags: ['React', 'AI'],
    bg: '#7c3aed', light: false, year: '2024', link: '#',
  ...
  },
  {
    ...
    tags: ['MERN', 'Audio'],
    bg: '#1db954', light: false, year: '2023', link: '#',
  ...
  },
  {
    ...
    bg: '#000000', light: false, year: '2024', link: '#',
    image: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&q=80&fit=crop',
  },
  {
    title: 'Zoom Clone',
    ...
    category: 'Platform Clones',
    tags: ['Next.js', 'WebRTC'],
    bg: '#2d8cff', light: false, year: '2024', link: '#',
  ...
  },
  {
    ...
    tags: ['Java', 'Firebase'],
    bg: '#fbbf24', light: false, year: '2022', link: '#',
  ...
  },
  {
    ...
    category: 'Mobile Applications',
    tags: ['Java', 'Material'],
    bg: '#374151', light: false, year: '2021', link: '#',
  ...
  },
  {
    ...
    category: 'Mobile Applications',
    tags: ['Flutter', 'Dart'],
    bg: '#0284c7', light: false, year: '2023', link: '#',
  ...
  },
  {
    ...
    bg: '#4f46e5', light: false, year: '2024', link: '#',
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80&fit=crop',
  },
  {
    title: 'Hirix API',
    desc: 'Node.js/Express backend with Clerk auth, Svix webhook verification, and n8n automation.',
    category: 'API Services',
    tags: ['Node.js', 'Express', 'Clerk'],
    bg: '#000000', light: false, year: '2024', link: '#',
